 ...
 *
 *         uint16 y1 = doubleIt(double u1)
 *
 *    Simulink version           : 9.3 (R2019a) 23-Nov-2018
 *    C source code generated on : 29-Dec-2020 21:31:08
 *
...
#define S_FUNCTION_NAME  ex_sfun_doubleit
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "doubleIt", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
